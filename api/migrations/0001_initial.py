# Generated by Django 3.1.2 on 2020-10-18 00:45
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ecnts', models.ManyToManyField(blank=True, related_name='paciente_profile', to='api.ECNT')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autocontrol_diabetes', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='api.autocontroldiabetes')),
            ],
        ),
        migrations.AddField(
